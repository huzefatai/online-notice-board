...
if ($name == "" || strlen($no) < 10 || $email == "" || $pwd == "") {

	$msg = "pls fill the inputs";
...
$conn->query("INSERT INTO login (name, number, email, pwd) VALUES ('$name', '$no', '$email', '$hashpwd');");
...
<div class= "container">
	...
	<duv class="user">
			<input  type="text" name="name" placeholder="Name" minlength = "4" required>
			<i class="fas fa-user"></i>
			</div>
			<div class="number">
		 	<input type="tel" name="no" placeholder="Mobile No." minlength = "10" maxlength="10" required>
